    ...
    <div>
        ...
        <?php 
                ...
                if(isset($_POST['submit']))
                {
                    ...
                    $sql3 = "INSERT INTO kupci(ime, prezime, email)
                    ...
                    //spremi u bazu
                    $sql2 = "INSERT INTO najmovi (voziloID, kupacID, imeVozila, cijena, brojDana, total, status, ime, prezime, email) VALUES ('".$car_id."','".$last_id."','".$imeVozila."', '".$cijena."', '".$brojdana."', '".$total."', '".$status."', '".$ime."', '".$prezime."', '".$email."')";
